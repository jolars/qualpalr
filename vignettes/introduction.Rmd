...
`qualpal` begins by generating a point cloud out of the HSL color subspace provided by the user, using a quasi-random sobol sequence from [randtoolbox](https://cran.r-project.org/package=DSviaDRM). Here is the color subset in HSL with settings `h = c(-200, 120), s = c(0.3, 0.8), l = c(0.4, 0.9)`.
